...
Console.Clear();
System.Console.Write("Задай координату A x:");
int userAX = int.Parse(Console.ReadLine());
System.Console.Write("Задай координату A y:");
int userAY = int.Parse(Console.ReadLine());

System.Console.Write("Задай координату B x:");
int userBX = int.Parse(Console.ReadLine());
System.Console.Write("Задай координату B y:");
int userBY = int.Parse(Console.ReadLine());

//int sqrX = (userBX - userAX) * (userBX - userAX);
double sqrX = Math.Pow(userBX - userAX, 2); //Math.Pow(а, 2) функция возводит в степень (переменная, в какую степень надо возвести)ь 
